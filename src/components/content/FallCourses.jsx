    ...
    <div>
      <div className="content5   h-[460px] border">
        <div className="text-center border">
          ...
          <h2 className="mt-[10px] text-center">دوره های جدید پاییزه</h2>
        </div>
        <div className="flex justify-center items-center gap-[20px] h-[300px] mt-[20px] border">
          <div className="overflow-hidden w-[25%] h-[280px] border rounded-[15px]">
            <div className="flex justify-center items-center w-[100%] h-[200px] bg-[#6F8EFF]">
              <img src="" alt=""/>
            </div>
          ...
          <div className="overflow-hidden w-[25%] h-[280px] border rounded-[15px]">
            <div className="flex justify-center items-center w-[100%] h-[200px] bg-[#EEEEEE]">
              <img src="" alt=""/>
              <img src="" alt=""/>
            </div>
          ...
          <div className="overflow-hidden w-[25%] h-[280px] border rounded-[15px]">
            <div className="flex justify-center items-center w-[100%] h-[200px] bg-[#DAE01E]">
              <img src="" alt=""/>
            </div>
            <h3 className="mt-[5px] mr-[10px] text-[14px]">دوره جاوااسکریپت</h3>
            <div className="flex justify-between items-center">
