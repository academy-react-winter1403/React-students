    ...
    <div>
        <div className="content1  w-[100%] h-[250px] pt-[60px] text-center border">
          <div className="w-[35%] mx-[auto] border">
            <p className="text-[25px]">با آکادمی سپهر میتونی از کدنویسی<span className="mx-[5px] px-[5px] py-[5px] text-[#A74DD1] border-[3px] border-[#A74DD1]"> نهایت لذت </span>رو ببری</p>
