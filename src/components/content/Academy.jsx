...
const Academy = () => {
  return (
    <div className="flex justify-between gap-[101px] border mt-[96px]   ts:justify-center">
      <div className="pr-[64px] border   ts:text-center">
        <button className="font-[bold] text-[#A74DD1] bg-[#F1D1FF]  ts:mt-[4px] ts:px-[8px] ts:py-[4px] ts:text-[8px] ts:rounded-[4px]    os:mt-[4px] os:px-[8px] os:py-[4px] os:text-[8px] os:rounded-[4px]    sm:mt-[8px] sm:px-[12px] sm:py-[4px] sm:text-[12px] sm:rounded-[8px]   lg:mt-[10px] lg:px-[16px] lg:py-[8px] lg:text-[12px] lg:rounded-[8px]">درباره آکادمی</button>
      ...
      <div className="flex justify-center items-end gap-[24px] ml-[81px] border   ts:hidden   xl:hidden "> 
