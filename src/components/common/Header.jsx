  ...
  return (
    <div className="header  flex justify-center items-center  gap-[350px] h-[100px] border">
      ...
      <div className="loginSignup  w-[9%] h-[60px] flex justify-center items-center gap-[10px] border">
        <a className="flex justify-center items-center w-[35%] h-[30px] text-[13px] font-bold border rounded-[10px]">ورود</a>
        <a className="flex justify-center items-center w-[55%] h-[30px] text-[13px] font-bold text-white bg-[#A74DD1] rounded-[10px]">ثبت نام</a>
      </div>
    </div>
  )
}
