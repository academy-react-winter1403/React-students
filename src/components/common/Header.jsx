...
const Header = () => {
  return (
    <div className="flex justify-between items-center border   ts:px-[16px] ts:mt-[4px]   sm:px-[32px] sm:mt-[12px]    lg:px-[64px] lg:mt-[20px]">
      <div className="flex justify-center items-center   ts:gap-[4px]   sm:gap-[6px]   lg:gap-[8px]">
        <img className="ts:w-[20px] ts:h-[20px]   sm:w-[32px] sm:h-[32px]   lg:w-[44px] lg:h-[44px]" src="" alt=""/>
        <h2 className="font-[semibold]    ts:text-[6px]    os:text-[10px]   sm:text-[12px]   lg:text-[14px]">React-students</h2>
      </div>
      ...
      <div className="flex justify-center items-center border   ts:gap-[4px]   os:gap-[8px]   sm:gap-[16px]   lg:gap-[24px]">
        ...
        <a className="flex justify-center items-center font-[semibold] text-white bg-[#A74DD1]   ts:px-[6px] ts:py-[2px] ts:text-[6px] ts:rounded-[4px]    os:px-[12px] os:py-[4px] os:text-[10px] os:rounded-[8px]    sm:px-[14px] sm:py-[6px] sm:text-[12px] sm:rounded-[10px]   lg:px-[16px] lg:py-[8px] lg:text-[16px] lg:rounded-[12px]">ثبت نام</a>
      </div>
    </div>
  )
}
