    ...
    <div className='w-[1230px] pr-6 py-6 bg-[#FCFCFC] rounded-3xl   dark:bg-[#606060]'>
      ...
      <div className='flex justify-start items-end gap-6 mt-8'>
        ...
        <div className='flex items-center gap-4'>
          <span className='font-[bold] text-[16px] text-[#2F2F2F]   dark:text-[#FFFFFF]'>ترتیب</span>
          <div className='flex justify-center items-center gap-2'>
            ...
            <div className='flex justify-center items-center w-[103px] h-[37px] border border-[#2F2F2F] rounded-[32px] cursor-pointer
              dark:border-[#FFFFFF]'> 
              <span className='font-[medium] text-[16px] text-[#2F2F2F]   dark:text-[#FFFFFF]'>تایید شده</span>
            </div>
          </div>
        </div>
      </div>
