...
const FallCourse = ({data}) => {
  return (
    <div>
      <div className="overflow-hidden border   ts:w-[120px] ts:h-[80px] ts:rounded-[12px]   os:w-[160px] os:h-[160px] os:rounded-[16px]   sm:w-[240px] sm:h-[240px] sm:rounded-[24px]   lg:w-[420px] lg:h-[336px] lg:rounded-[24px]">
        <div className={`flex justify-center items-center bg-[${data.backGroundColor}]    ts:h-[40px] ts:rounded-b-[20px]   os:h-[100px] os:rounded-b-[20px]   sm:h-[160px] sm:rounded-b-[28px]   lg:h-[241px] lg:rounded-b-[40px] relative`}>
          <img className="ts:w-[14px] ts:h-[14px]   os:w-[28px] os:h-[28px]   sm:w-[56px] sm:h-[56px]   lg:w-[112px] lg:h-[112px]" src={data.mainImg} alt="Icon"/>
        ...
        <div className="ts:pr-[4px]   os:pr-[8px]   sm:pr-[12px]   lg:pr-[16px]">
          <h3 className="font-[bold]   ts:mt-[4px] ts:text-[8px]   os:mt-[8px] os:text-[12px]   sm:mt-[12px] sm:text-[16px]   lg:mt-[12px] lg:text-[24px]">{data.title}</h3>
          <div className="flex justify-between items-center   ts:mt-[4px]   os:mt-[8px]   sm:mt-[12px]   lg:mt-[12px]">
            <div className="flex items-center border   ts:gap-[4px]   os:gap-[4px]   sm:gap-[8px]   lg:gap-[8px]">
              ...
              <span className="font-[semibold] text-[#959595]   ts:text-[4px]   os:text-[6px]   sm:text-[8px]   lg:text-[14px]">{data.teacher}</span>
            </div>
            <div className="flex items-center gap-[4px] border   ts:ml-[4px]   os:ml-[8px]   sm:ml-[12px]   lg:ml-[16px]">
              <span className="font-[semibold]   ts:text-[8px]   os:text-[8px]   sm:text-[14px]   lg:text-[20px]">{data.price}</span><span className="font-[semibold]   ts:text-[4px]   os:text-[6px]   sm:text-[10px]   lg:text-[14px]">تومان</span>
            </div>
          </div> 
        </div>
      </div>
