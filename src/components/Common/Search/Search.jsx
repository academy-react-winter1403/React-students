...
const Search = ({ onSearchChange }) => {
  ...
  return (
    <div className="mt-[12px] ts:mt-[8px] os:mt-[12px] sm:mt-[16px] lg:mt-[20px]">
      ...
      <div className="flex items-center relative   ts:mt-[4px]   os:mt-[4px]   sm:mt-[8px]   lg:mt-[12px]">
        ...
        />
        <span
          className="flex justify-center items-center bg-[#A74DD0] cursor-pointer absolute top-0   ts:w-[24px] ts:h-[24px]
