  ...
  return (
    <div className="flex justify-center gap-[16px]   2x:mt-[53px] 2x:pr-[96px] 2x:pl-[108px]">
        ...
        <div className="2x:mr-[63px]">
            ...
            <div className="ts:w-[120px] ts:mt-[4px]   os:w-[160px] os:mt-[8px]   sm:w-[240px] sm:mt-[12px]   lg:w-[306px] lg:mt-[16px]">
            ...
            <div className="ts:w-[120px] ts:mt-[4px]   os:w-[160px] os:mt-[8px]   sm:w-[240px] sm:mt-[12px]   lg:w-[328px] lg:mt-[16px]">
