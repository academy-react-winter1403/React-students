...
const WeeklyBlog = ({ data }) => {
  ...
  return (
    <div className="group overflow-hidden border   ts:w-[100px] ts:h-[80px] ts:rounded-[8px]   os:w-[160px] os:h-[120px] os:rounded-[16px]   sm:w-[280px] sm:h-[180px] sm:rounded-[20px]   lg:w-[420px] lg:h-[336px] lg:rounded-[24px]">
