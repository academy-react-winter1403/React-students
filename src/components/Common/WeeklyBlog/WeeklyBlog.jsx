...
const WeeklyBlog = ({ data }) => {
  ...
  return (
    <div className="group overflow-hidden border   ts:w-[300px] ts:h-[220px] ts:rounded-[16px]   sm:w-[360px] sm:h-[260px] sm:rounded-[20px]   lg:w-[420px] lg:h-[336px] lg:rounded-[24px]">
