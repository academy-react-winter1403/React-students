...
import Styles from '../CourseList/Card.module.css'
...
console.log(Id)
  ...
  return (
    <div 
        className="overflow-hidden bg-[#EAEAEA] cursor-pointer   dark:bg-[#606060]
    ...
    >
        ...
        <div className="ts:mt-[4px] ts:pr-[4px]   os:mt-[4px] os:pr-[8px]   sm:mt-[8px] sm:pr-[12px]   lg:mt-[8px] lg:pr-[16px]">
            <div className="flex   ts:gap-[4px]   os:gap-[4px]   sm:gap-[8px]   lg:gap-[8px]">
                <button className="font-[semibold] text-[#A74DD0] bg-[#F1D1FF]   dark:text-[#FFFFFF]
                    ts:px-[8px] ts:py-[4px] ts:text-[6px] ts:rounded-[4px]   os:px-[8px] os:py-[4px] os:text-[8px] os:rounded-[4px]   sm:px-[8px] sm:py-[4px] sm:text-[12px] sm:rounded-[8px]   lg:px-[8px] lg:py-[5px] lg:text-[12px] lg:rounded-[8px]">
                    {data.categoryName}
                </button>
            </div>
            ...
            <div className="flex items-center   
                ts:gap-[4px] ts:mt-[4px]   os:gap-[4px] os:mt-[4px]   sm:gap-[8px] sm:mt-[8px]   lg:gap-[8px] lg:mt-[16px]">
            ...
            <div className="flex items-center   
                ts:gap-[4px] ts:mt-[4px]   os:gap-[4px] os:mt-[4px]   sm:gap-[8px] sm:mt-[8px]   lg:gap-[8px] lg:mt-[8px]">
            ...
            <div className="flex items-center   
                ts:gap-[16px] ts:mt-[12px]   os:gap-[28px] os:mt-[16px]   sm:gap-[60px] sm:mt-[20px]   lg:gap-[107px] lg:mt-[26px]">
                ...
                <div className="flex items-center mr-[auto]   
                    ts:gap-[4px] ts:ml-[8px]   os:gap-[4px] os:ml-[16px]   sm:gap-[8px] sm:ml-[20px]   lg:gap-[8px] lg:ml-[24px]">
