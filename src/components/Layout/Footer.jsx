...
=======
      <div className="flex justify-center items-center border   ts:gap-[12px]   os:gap-[24px]   sm:gap-[36px]   lg:gap-[48px]   2x:mr-[199px] 2x:ml-[302px]">
...
>>>>>>> 779cf64b6ecbd9c6f8e38f09be3a25629d4b501b:src/components/footer/Footer.jsx
      </div>
