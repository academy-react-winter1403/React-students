  ...
  return (
    <div>
            <div className='w-full h-[auto]'> 
                <div className='w-ful h-[auto]'>
                    ...
                    <div className='h-[90px] flex items-center'>
                        ...
                        <div className=' flex flex-col w-[700px] mt-[11px] mr-[12px]'>
                            <h2 className='font-bold'>تایتل نظر</h2>
                            <p>متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر</p>
                        </div>
                   </div>
            ...
            <div className='h-[45px] flex items-center pr-5'>
                    ...
                    <div className='h-[90px] flex items-center'>
                        <img className='h-5 pr-8' src={Arrow} alt="arrow pics" />
                        <div className=' flex flex-col w-[700px] mr-[12px]'>
                            <h2 className='font-bold'>تایتل نظر</h2>
                            <p>متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر متن نظر</p>
                        </div>
                   </div>
