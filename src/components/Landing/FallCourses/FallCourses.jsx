...
<<<<<<< HEAD:src/components/Landing/FallCourses.jsx
<<<<<<< HEAD
<<<<<<< HEAD
import HtmlIcon2 from '../Icons/HtmlIcon2'
import CssIcon2 from '../Icons/CssIcon2'
import JsIcon2 from '../Icons/JsIcon2'
import ReactIcon2 from '../Icons/ReactIcon2'
...
import ArrowLeftIcon from '../../../assets/Icons/arrow-left.svg'
import VectorLine3 from '../../../assets/Icons/Group 7.svg'
>>>>>>> landingcourse:src/components/Landing/FallCourses/FallCourses.jsx
...
<<<<<<< HEAD
<<<<<<< HEAD
            <ReactIcon2 className="ts:w-[14px] ts:h-[14px]   os:w-[28px] os:h-[28px]   sm:w-[56px] sm:h-[56px]   lg:w-[112px] lg:h-[112px]"/>
=======
<<<<<<< HEAD
...
=======
          ...
          <h3 className="font-[bold]   ts:mt-[4px] ts:mr-[8px] ts:text-[8px]   os:mt-[8px] os:mr-[12px] os:text-[12px]   sm:mt-[12px] sm:mr-[16px] sm:text-[16px]   lg:mt-[12px] lg:mr-[16px] lg:text-[24px]">دوره جاوااسکریپت</h3>
          <div className="flex justify-between items-center   ts:mt-[4px]   os:mt-[8px]   sm:mt-[12px]   lg:mt-[12px]">
            <div className="flex items-center border   ts:gap-[4px] ts:mr-[8px]   os:gap-[4px] os:mr-[8px]   sm:gap-[8px] sm:mr-[12px]   lg:gap-[8px] lg:mr-[16px]">
        ...
        <div className="overflow-hidden border   ts:w-[260px] ts:h-[80px] ts:rounded-[12px]   os:w-[300px] os:h-[160px] os:rounded-[16px]   sm:w-[340px] sm:h-[240px] sm:rounded-[24px]   lg:w-[420px] lg:h-[336px] lg:rounded-[24px]">
          ...
          <h3 className="font-[bold]   ts:mt-[4px] ts:mr-[8px] ts:text-[8px]   os:mt-[8px] os:mr-[12px] os:text-[12px]   sm:mt-[12px] sm:mr-[16px] sm:text-[16px]   lg:mt-[12px] lg:mr-[16px] lg:text-[24px]">دوره html و CSS</h3>
          <div className="flex justify-between items-center   ts:mt-[4px]   os:mt-[8px]   sm:mt-[12px]   lg:mt-[12px]">
            <div className="flex items-center border   ts:gap-[4px] ts:mr-[8px]   os:gap-[4px] os:mr-[8px]   sm:gap-[8px] sm:mr-[12px]   lg:gap-[8px] lg:mr-[16px]">
              <img className="ts:w-[12px] ts:h-[12px]   os:w-[16px] os:h-[16px]   sm:w-[20px] sm:h-[20px]   lg:w-[24px] lg:h-[24px]" src="" alt=""/>
              <span className="font-[semibold] text-[#959595]   ts:text-[4px]   os:text-[6px]   sm:text-[8px]   lg:text-[14px]">محمدحسین بحرالعلومی</span>
