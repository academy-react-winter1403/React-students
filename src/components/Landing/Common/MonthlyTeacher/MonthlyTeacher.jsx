...
const MonthlyTeacher = ({data}) => {
  return (
    <div className="flex-shrink-0 border-2 border-[#FFBF6C] 
      ...
      <h3 className="font-[bold]   ts:text-[16px]   os:text-[16px]   sm:text-[20px]   lg:text-[20px]   dark:text-gray-300">
        {`رتبه ${data.teacherId}`}
      </h3>
      <div className="flex justify-between items-end">
        <div>
          ...
          <h2 className="font-[semibold]  
            ts:text-[16px] ts:mt-[4px]   ostext-[16px]   sm:mt-[8px] sm:text-[20px]   lg:mt-[8px] lg:text-[20px]   
            dark:text-gray-300">
            {data.fullName}
          </h2>
