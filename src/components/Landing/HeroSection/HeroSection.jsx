...
const HeroSection = () => {
  return (
    <div className="mx-[auto] text-center   ts:mt-[12px]   os:mt-[28px]   sm:mt-[44px]   lg:mt-[88px]">
      <div>
        <div>
          <p className="font-[semibold]   ts:text-[16px]   os:text-[24px]    sm:text-[32px]   lg:text-[40px]">با آکادمی سپهر ، میتونی از کدنویسی</p>
        </div>
