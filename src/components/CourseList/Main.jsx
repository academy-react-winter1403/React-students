...
const Main = () => {
  return (
    <div className="border   ts:w-[720px]   os:w-[800px]   sm:w-[880px]   lg:w-[958.6px]">
        <div className="flex items-center bg-[#F8F8F8]   ts:w-[716px] ts:h-[36px] ts:pr-[12px] ts:pl-[12px] ts:rounded-[24px]   os:w-[796px] os:h-[48px] os:pr-[16px] os:pl-[16px] os:rounded-[24px]   sm:w-[876px] sm:h-[60px] sm:pr-[20px] sm:pl-[20px] sm:rounded-[24px]   lg:w-[956px] lg:h-[72px] lg:pr-[26px] lg:pl-[24px] lg:rounded-[24px]">
        ...
        <div className="flex flex-row flex-wrap   ts:gap-[8px] ts:mt-[8px]   os:gap-[16px] os:mt-[16px]   sm:gap-[24px] sm:mt-[24px]   lg:gap-[33px] lg:mt-[32px]">
          <CourseCard/>
          <CourseCard/>
          <CourseCard/>
          <CourseCard/>
        ...
        <div className="flex items-center mx-[auto] border   ts:gap-[8px] ts:w-[220px] ts:mt-[16px]   os:gap-[8px] os:w-[280px] os:mt-[24px]   sm:gap-[12px] sm:w-[340px] sm:mt-[32px]   lg:gap-[12px] lg:w-[404px] lg:mt-[40px]">
          <div className="flex justify-center items-center border border-[#A74DD0]   ts:w-[24px] ts:h-[16px] ts:rounded-[4px]   os:w-[32px] os:h-[24px] os:rounded-[4px]   sm:w-[36px] sm:h-[32px] sm:rounded-[8px]   lg:w-[40px] lg:h-[40px] lg:rounded-[8px]">
            <FrameRightIcon className="ts:w-[8px] ts:h-[8px]   os:w-[12px] os:h-[12px]   sm:w-[16px] sm:h-[16px]   lg:w-[20px] lg:h-[20px]" src={FrameRightIcon} alt="frameRightIcon"/>
          </div>
          ...
          <div className="flex justify-center items-center border border-[#A74DD0]    ts:w-[24px] ts:h-[16px] ts:rounded-[4px]   os:w-[32px] os:h-[24px] os:rounded-[4px]   sm:w-[36px] sm:h-[32px] sm:rounded-[8px]   lg:w-[40px] lg:h-[40px] lg:rounded-[8px]">
            <FrameLeftIcon className="ts:w-[8px] ts:h-[8px]   os:w-[12px] os:h-[12px]   sm:w-[16px] sm:h-[16px]   lg:w-[20px] lg:h-[20px]" src={FrameLeftIcon} alt="frameLeftIcon"/>
          </div>
        </div>
    </div>
  )
