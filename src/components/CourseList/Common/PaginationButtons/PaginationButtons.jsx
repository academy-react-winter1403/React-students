...
const PaginationButtons = ({ currentPage, totalPages, onPageChange }) => {
  ...
  return (
    <div>
      <div className="flex justify-center items-center mx-[auto]   ts:gap-[8px] ts:mt-[16px]   os:gap-[8px] os:mt-[24px]   sm:gap-[12px] sm:mt-[32px]   lg:gap-[12px] lg:mt-[40px]">
        <button
          className="flex justify-center items-center border border-[#A74DD0] cursor-pointer   ts:w-[16px] ts:h-[16px] ts:rounded-[4px]   os:w-[24px] os:h-[24px] os:rounded-[4px]   sm:w-[32px] sm:h-[32px] sm:rounded-[8px]   lg:w-[40px] lg:h-[40px] lg:rounded-[8px]"
        ...
        {pageNumbers.map(number => (
          <button
            className={`flex justify-center items-center font-[semibold] text-[#A74DD0] border border-[#A74DD0] cursor-pointer   ts:w-[16px] ts:h-[16px] ts:text-[6px] ts:rounded-[4px]   os:w-[24px] os:h-[24px] os:text-[8px] os:rounded-[4px]   sm:w-[32px] sm:h-[32px] sm:text-[12px] sm:rounded-[8px]   lg:w-[40px] lg:h-[40px] lg:text-[16px] lg:rounded-[8px] ${currentPage === number ? 'bg-[#F5DDFF]' : ''}`}
            key={number}
