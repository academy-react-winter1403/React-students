  ...
  return (
    <div
      ...
      <div className="flex justify-center bg-[#DAE01E]   
        ...
        sm:h-[160px] sm:pt-[40px] sm:rounded-b-[32px]   
        lg:h-[191px] lg:pt-[48px] lg:rounded-b-[32px]">
        <img
      ...
      <div className="ts:mt-[4px] ts:pr-[4px]   os:mt-[4px] os:pr-[8px]   sm:mt-[8px] sm:pr-[12px]   lg:mt-[8px] lg:pr-[16px]">
        ...
        <div className="flex items-center   
          ...
          os:gap-[4px] os:mt-[4px]   
          sm:gap-[8px] sm:mt-[8px]   
          lg:gap-[8px] lg:mt-[16px]">
          <img
        ...
        <div className="flex items-center   
          ...
          os:gap-[16px] os:mt-[16px]   
          sm:gap-[24px] sm:mt-[20px]   
          lg:gap-[38px] lg:mt-[24px]">
