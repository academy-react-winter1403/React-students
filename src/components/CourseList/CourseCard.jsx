    ...
    <div
      ...
      <div className="ts:mt-[4px] ts:pr-[4px]   os:mt-[4px] os:pr-[8px]   sm:mt-[8px] sm:pr-[12px]   lg:mt-[8px] lg:pr-[16px]">
        <div className="flex   ts:gap-[4px]   os:gap-[4px]   sm:gap-[8px]   lg:gap-[8px]">
          <span className="font-[semibold] text-[#A74DD0] bg-[#F1D1FF]   ts:px-[8px] ts:py-[4px] ts:text-[6px] ts:rounded-[4px]   os:px-[8px] os:py-[4px] os:text-[8px] os:rounded-[4px]   sm:px-[8px] sm:py-[4px] sm:text-[12px] sm:rounded-[8px]   lg:px-[8px] lg:py-[5px] lg:text-[12px] lg:rounded-[8px]">
            {data.levelName}
          </span>
          <span className="font-[semibold] text-[#A74DD0] bg-[#F1D1FF]   ts:px-[8px] ts:py-[4px] ts:text-[6px] ts:rounded-[4px]   os:px-[8px] os:py-[4px] os:text-[8px] os:rounded-[4px]   sm:px-[8px] sm:py-[4px] sm:text-[12px] sm:rounded-[8px]   lg:px-[8px] lg:py-[5px] lg:text-[12px] lg:rounded-[8px]">
            {data.statusName}
        ...
        <div className="flex items-center   ts:gap-[8px] ts:mt-[12px]   os:gap-[16px] os:mt-[16px]   sm:gap-[24px] sm:mt-[20px]   lg:gap-[38px] lg:mt-[24px]">
