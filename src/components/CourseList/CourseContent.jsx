...
const CourseContent = () => {
  ...
  return (
    <div className="flex justify-center w-full   ts:gap-[4px] ts:mt-[8px] ts:px-[8px]   os:gap-[12px] os:mt-[8px] os:px-[20px]   sm:gap-[24px] sm:mt-[10px] sm:px-[32px]   lg:gap-[40px] lg:mt-[10px] lg:px-[64px]">
      ...
      <div>
        <CourseSort onItemsPerPageChange={handleItemsPerPageChange} currentItemsPerPage={itemsPerPage} onSort={() => {}} />
        <CourseMain courses={filteredCourses} searchTerm={searchTerm} currentPage={currentPage} itemsPerPage={itemsPerPage} />
